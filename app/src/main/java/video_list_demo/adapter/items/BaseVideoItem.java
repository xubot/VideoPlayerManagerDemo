package video_list_demo.adapter.items;
...
import video_list_demo.adapter.VideoRecyclerViewAdapter;
...
public abstract class BaseVideoItem implements VideoItem, ListItem{
     ...
     */
    public abstract void update(int position, VideoRecyclerViewAdapter.VideoViewHolder view, VideoPlayerManager videoPlayerManager);
    ...
    public void setActive(View newActiveView, int newActiveViewPosition) {
        VideoRecyclerViewAdapter.VideoViewHolder viewHolder = (VideoRecyclerViewAdapter.VideoViewHolder) newActiveView.getTag();
    ...
    public View createView(ViewGroup parent, int screenWidth) {
        ...
        final VideoRecyclerViewAdapter.VideoViewHolder videoViewHolder = new VideoRecyclerViewAdapter.VideoViewHolder(view);
    ...
    private void setVisibilityPercentsText(View currentView, int percents) {
        ...
        VideoRecyclerViewAdapter.VideoViewHolder videoViewHolder = (VideoRecyclerViewAdapter.VideoViewHolder) currentView.getTag();
